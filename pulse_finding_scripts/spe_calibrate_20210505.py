...
data_dir = "G:/.shortcut-targets-by-id/11qeqHWCbcKfFYFQgvytKem8rulQCTpj8/crystalize/data/data-202105/20210504/20210504_1637_spe_calibration/"
    ...
    for i in range(j*block_size, j*block_size+n_events):
        ...
        for k in range(n_sipms):
            ...
            if SPEMode:
                ...
                p_start[k,i,0] = left_bound
                p_end[k,i,0] = right_bound
